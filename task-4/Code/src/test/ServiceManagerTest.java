...
public class ServiceManagerTest {
    ...
    public void testCreateOrder() {
        ...
        assert !master.isAvailable() && place.isOccupied() : "Failed to create order.";
    }
    ...
    public void testCompleteOrder() {
        ...
        assert order.getStatusOrder() == OrderStatus.COMPELETED : "Failed to complete order.";
    }
    ...
    public void testGetOrdersByStatusAndTimeFrame() {
        ServiceManager manager = new ServiceManager();
        List<Order> orders = manager.getOrdersByStatusAndTimeFrame(OrderStatus.COMPELETED, LocalDateTime.now().minusDays(1), LocalDateTime.now());
