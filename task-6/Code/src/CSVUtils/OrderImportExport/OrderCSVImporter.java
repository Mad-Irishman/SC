...
public class OrderCSVImporter {
    ...
    public static void importOrdersFromCSV(ServiceManager serviceManager, String filePath) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                boolean orderExists = existingOrders.stream()
                        .anyMatch(order -> order.getIdOrder() == Integer.parseInt(id) || order.getDescription().equals(description));
